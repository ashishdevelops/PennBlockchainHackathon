...
interface WalletButtonProps extends React.ComponentPropsWithoutRef<'button'>, BaseProps {}
...
const WalletButton = ({ Icon, children, ...rest }: WalletButtonProps | IconLinkProps) => (
  <IconBlock {...rest}>
    <IconWrapper>
